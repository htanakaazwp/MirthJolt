 ...
 * This file demonstrates how to integrate Mirthjolt with a web frontend
 */

// For React/Vue/Angular applications
export class MirthjoltClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MirthjoltClient(provider, contractAddress);
